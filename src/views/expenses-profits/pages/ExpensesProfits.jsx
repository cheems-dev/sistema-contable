              ...
              <CTable align="middle" className="border  rounded" hover responsive>
                <CTableHead className="text-nowrap">
                  <CTableRow>
                    ...
                    <CTableHeaderCell className="text-end">Enero Real</CTableHeaderCell>
                    <CTableHeaderCell className="text-end">Enero Presupuesto</CTableHeaderCell>
                    <CTableHeaderCell className="text-end">Febrero Real</CTableHeaderCell>
                    <CTableHeaderCell className="text-end">Febrero Presupuesto</CTableHeaderCell>
